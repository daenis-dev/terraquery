CITY_QUERIES = [
    # Find cities with a population greater than, at least, less than, at most (5,000 - 400,000)
    {
        "natural-language": "Find cities with a population greater than five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 15000"
    },
    {
        "natural-language": "Find cities with a population greater than twenty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 20000"
    },
    {
        "natural-language": "Find cities with a population greater than twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than thirty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 35000"
    },
    {
        "natural-language": "Find cities with a population greater than forty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 40000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than fifty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 55000"
    },
    {
        "natural-language": "Find cities with a population greater than sixty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 60000"
    },
    {
        "natural-language": "Find cities with a population greater than sixty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 65000"
    },
    {
        "natural-language": "Find cities with a population greater than seventy thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 70000"
    },
    {
        "natural-language": "Find cities with a population greater than seventy five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than eighty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 85000"
    },
    {
        "natural-language": "Find cities with a population greater than ninety thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 90000"
    },
    {
        "natural-language": "Find cities with a population greater than ninety five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than one hundred fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than one hundred twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 125000"
    },
    {
        "natural-language": "Find cities with a population greater than one hundred thirty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 130000"
    },
    {
        "natural-language": "Find cities with a population greater than one hundred forty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 5000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 15000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 25000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 35000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 55000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 65000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 75000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 85000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 95000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 115000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 125000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 125000"
    },
    {
        "natural-language": "Find cities with a population greater than 130000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 130000"
    },
    {
        "natural-language": "Find cities with a population greater than 140000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 5,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 15,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 25,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 35,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 55,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 65,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 75,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 85,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 95,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 115,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population greater than 125,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 125000"
    },
    {
        "natural-language": "Find cities with a population greater than 130,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 130000"
    },
    {
        "natural-language": "Find cities with a population greater than 140,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population > 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least thirty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least fifty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least sixty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least seventy five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least eighty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least ninety five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least one hundred fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least one hundred twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 125000"
    },
    {
        "natural-language": "Find cities with a population of at least one hundred thirty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 130000"
    },
    {
        "natural-language": "Find cities with a population of at least one hundred forty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 5000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 15000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 25000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 35000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 55000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 65000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 75000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 85000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 95000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 115000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 125000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 125000"
    },
    {
        "natural-language": "Find cities with a population of at least 130000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 130000"
    },
    {
        "natural-language": "Find cities with a population of at least 140000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 5,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 15,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 25,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 35,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 55,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 65,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 75,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 85,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 95,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 115,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at least 125,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 125000"
    },
    {
        "natural-language": "Find cities with a population of at least 130,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 130000"
    },
    {
        "natural-language": "Find cities with a population of at least 140,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population >= 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than thirty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than fifty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than sixty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than seventy five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than eighty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than ninety five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than one hundred fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than one hundred twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 125000"
    },
    {
        "natural-language": "Find cities with a population less than one hundred thirty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 130000"
    },
    {
        "natural-language": "Find cities with a population less than one hundred forty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 5000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 15000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 25000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 35000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 55000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 65000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 75000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 85000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 95000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 115000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 125000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 125000"
    },
    {
        "natural-language": "Find cities with a population less than 130000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 130000"
    },
    {
        "natural-language": "Find cities with a population less than 140000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 5,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 15,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 25,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 35,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 55,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 65,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 75,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 85,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 95,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 115,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population less than 125,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 125000"
    },
    {
        "natural-language": "Find cities with a population less than 130,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 130000"
    },
    {
        "natural-language": "Find cities with a population less than 140,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population < 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most thirty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most fifty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most sixty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most seventy five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most eighty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most ninety five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most one hundred fifteen thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most one hundred twenty five thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 125000"
    },
    {
        "natural-language": "Find cities with a population of at most one hundred thirty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 130000"
    },
    {
        "natural-language": "Find cities with a population of at most one hundred forty thousand people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 5000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 15000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 25000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 35000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 55000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 65000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 75000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 85000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 95000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 115000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 125000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 125000"
    },
    {
        "natural-language": "Find cities with a population of at most 130000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 130000"
    },
    {
        "natural-language": "Find cities with a population of at most 140000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 140000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 5,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 5000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 15,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 15000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 25,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 25000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 35,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 35000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 55,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 55000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 65,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 65000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 75,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 75000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 85,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 85000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 95,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 95000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 115,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 115000"
    },
    {
    ...
    {
        "natural-language": "Find cities with a population of at most 125,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 125000"
    },
    {
        "natural-language": "Find cities with a population of at most 130,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 130000"
    },
    {
        "natural-language": "Find cities with a population of at most 140,000 people",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE population <= 140000"
    },
    {
    ...
    # Find cities by area greater than, at least, less than and at most (1 - 200 sq km)
    {
        ...
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 1000000"
    },
    {
        "natural-language": "Find cities with an area greater than two square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 2000000"
    },
    {
        "natural-language": "Find cities with an area greater than three square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 3000000"
    },
    {
        "natural-language": "Find cities with an area greater than four square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 4000000"
    },
    {
        "natural-language": "Find cities with an area greater than five square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 5000000"
    },
    {
        "natural-language": "Find cities with an area greater than six square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 6000000"
    },
    {
        "natural-language": "Find cities with an area greater than seven square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 7000000"
    },
    {
        "natural-language": "Find cities with an area greater than eight square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 8000000"
    },
    {
        "natural-language": "Find cities with an area greater than nine square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 9000000"
    },
    {
        "natural-language": "Find cities with an area greater than ten square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 10000000"
    },
    {
        "natural-language": "Find cities with an area greater than eleven square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 11000000"
    },
    {
        "natural-language": "Find cities with an area greater than twelve square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 12000000"
    },
    {
        "natural-language": "Find cities with an area greater than thirteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 13000000"
    },
    {
        "natural-language": "Find cities with an area greater than fourteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 14000000"
    },
    {
        "natural-language": "Find cities with an area greater than fifteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 15000000"
    },
    {
        "natural-language": "Find cities with an area greater than sixteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 16000000"
    },
    {
        "natural-language": "Find cities with an area greater than seventeen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 17000000"
    },
    {
        "natural-language": "Find cities with an area greater than eighteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 18000000"
    },
    {
        "natural-language": "Find cities with an area greater than nineteen square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 19000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 20000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty one square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 21000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty two square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 22000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty three square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 23000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty four square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 24000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty five square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 25000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty six square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 26000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty seven square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 27000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty eight square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 28000000"
    },
    {
        "natural-language": "Find cities with an area greater than twenty nine square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 29000000"
    },
    {
        "natural-language": "Find cities with an area greater than thirty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 30000000"
    },
    {
        "natural-language": "Find cities with an area greater than forty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 40000000"
    },
    {
        "natural-language": "Find cities with an area greater than fifty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 50000000"
    },
    {
        "natural-language": "Find cities with an area greater than sixty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 60000000"
    },
    {
        "natural-language": "Find cities with an area greater than seventy square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 70000000"
    },
    {
        "natural-language": "Find cities with an area greater than eighty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 80000000"
    },
    {
        "natural-language": "Find cities with an area greater than ninety square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 90000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 100000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred ten square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 110000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred twenty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 120000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred thirty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 130000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred forty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 140000000"
    },
    {
        "natural-language": "Find cities with an area greater than one hundred fifty square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 150000000"
    },
    {
        "natural-language": "Find cities with an area greater than two hundred square kilometers",
        "sql": "SELECT name, ST_AsGeoJSON(boundary) AS boundary FROM cities WHERE ST_Area(ST_Transform(boundary, 3310 )) > 200000000"
    },
    {
